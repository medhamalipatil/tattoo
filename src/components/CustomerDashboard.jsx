...
export default function CustomerDashboard({ bookings, userCredentials, globalCatalog, setActiveTab }) {
  ...
  return (
    <div className="animate-fade-in" style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
      ...
      {/* Welcome Header */}
      <div className="glass-panel" style={{ padding: '2rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '1.5rem', flexWrap: 'wrap' }}>
        <div>
            ...
            {filtered.map(b => {
              ...
              return (
                <div
                  ...
                  onMouseEnter={e => e.currentTarget.style.borderColor = 'rgba(0, 242, 254, 0.15)'}
